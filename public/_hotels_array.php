...
$restaurantsInformations = [
    ...
    [
        'restaurantCompagnyName' => ['tout est bon dans le cochon'],
    ...
    [
        'restaurantCompagnyName' => ['InterContinental Lyon - Hotel Dieu'],
        'restaurantBookingUrl' => ['https://lyon.intercontinental.com/reservation/'],
        'restaurantCallingNumber' => ['+33426992323'],
        'restaurantWebSiteUrl' => ['https://lyon.intercontinental.com/'],
        'restaurantPostalAddress' => ['20 quai Jules Courmont 69002 Lyon'],
        ...
        'restaurantImageLink' => ['./src/assets/picture/lyon-hoteldieu.jpg']
    ]
];
