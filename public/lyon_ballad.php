...
<body>
    ...
    <main class = "mainBallad">
        ...
        <article>
            <iframe class="myMapsBallad" id="oneDayBallad" src="https://www.google.com/maps/d/embed?mid=1k6HnWGIYafP2l3RmQTJobhyy5RTvUOwR&ehbc=2E312F" width="100%" height="350" ></iframe>
        ...
        <article>
            <iframe class="myMapsBallad" id="twoDaysBallad" src="https://www.google.com/maps/d/embed?mid=1P0iR-xrCRzxUj_3u8U30WID8TiySdFzD&ehbc=2E312F" width="100%" height="350"></iframe>
