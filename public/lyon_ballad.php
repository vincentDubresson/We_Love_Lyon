...
<body>
    ...
    <main class = "mainBallad">
        ...
        <article>
            ...
            <div class="journey">
                <p><img class="journeyFloatLeft" src="https://via.placeholder.com/250x150" alt=""> - <em>MATIN</em> - Il est <strong>8h00</strong>, Lyon s'éveille... Votre journée commence par l'un des plus beaux marché de Lyon.
                ...
                <p><img class="journeyFloatRight" src="https://via.placeholder.com/250x150" alt=""> - Poursuivez-votre balade, en vous attardant dans le <strong>Vieux Lyon</strong>, quartier historique de la Ville. Perdez-vous dans ces
                ...
                <p><img class="journeyFloatLeft" src="https://via.placeholder.com/250x150" alt=""> - <em>APRÈS-MIDI</em> - Après ce repas succuleux, il
                ...
                <p><img class="journeyFloatRight" src="https://via.placeholder.com/250x150" alt=""> - Cette journée se termine bientôt. Prenez la célèbre <em>Rue de la République</em> (Rue de la Ré pour les Lyonnais) jusqu'à trouver la <em>rue Mercière</em>,
        ...
        <article>
            ...
            <div class="journey">
                <p><img class="journeyFloatLeft" src="https://via.placeholder.com/250x150" alt=""> - <em>MATIN</em> - Après une journée bien chargée, nous vous proposons un deuxième
                ...
                <p><img class="journeyFloatRight" src="https://via.placeholder.com/250x150" alt=""> - <em>APRÈS-MIDI</em> Dirigez vous vers la <em>rue Victor Hugo</em>, une artère très commerçante du 2ème Arrondissement. Dans le prolongement, vous accèderez à la <strong>Place Carnot</strong>. Célèbre en période de fête pour son marché de Noël, cette petite
